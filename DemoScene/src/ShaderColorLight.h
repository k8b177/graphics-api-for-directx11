...
public:
	...
	void SetPointLightParameters(int lightID, const Vect& pos, float r, const Vect& att, const Vect& amb = Vect(1, 1, 1), const Vect& dif = Vect(1, 1, 1), const Vect& sp = Vect(1, 1, 1));
	void SetSpotLightParameters(int lightID, const Vect& pos, float r, const Vect& att, const Vect& dir, float spotExp, const Vect& amb = Vect(1, 1, 1), const Vect& dif = Vect(1, 1, 1), const Vect& sp = Vect(1, 1, 1));
...
private:
	static const int POINTLIGHT_MAX = 10;
	static const int SPOTLIGHT_MAX = 10;
	int PntlightCnt;
	int SpotlightCnt;
	...
	PointLight PointLightData[POINTLIGHT_MAX];
	...
	SpotLight SpotLightData[SPOTLIGHT_MAX];
	...
	struct Data_LightParams
	{
		...
		PointLight PntLight[POINTLIGHT_MAX];
		SpotLight SptLight[SPOTLIGHT_MAX];
		Vect EyePosWorld;
	};
